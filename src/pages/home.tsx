  ...
  return (
    <div className="homeMain">
      ...
      <p>
        ...
        music or art.</p>
      <p className="FSMC"> 
        I've graduated from the Politehnica University of Bucharest with a master's degree in Graphics, Multimedia and Virtual Reality and have extensive programming experience, 
        focusing mainly on Object-Oriented Programming. I've also worked on various projects (more info on the Projects page) such as: <br/>
        - A VR game made to help with hand/arm exercise in healthcare <br/>
        - BeatDungeon, a rhythm game I've made for a Ubisoft game jam, reaching top 10 <br/>
        - Database-related work at SOR (BirdLife Romania)</p>
      <p className= "TBMC">
