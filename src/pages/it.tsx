...
function IT() {
  ...
  return (
    ...
    <div className="itMain">
      ...
      hand movement etc." depthDescription2='' videoLink="https://www.youtube.com/embed/ry7KRNBON04?si=OhhW1TEjresR_9SK" imagePath=""></ProjectBox>
      ...
      shooting an arrow to teleport at its location." depthDescription2='' videoLink="https://www.youtube.com/embed/Hlxo-54WMJM?si=xwhW7xP2eJxrDX_T" imagePath=""></ProjectBox>
      ...
      scene and has the main loop, deltaTime, a function to pause and one to close the project; the main class initializes everything. Extra features have also been developed, such as
      a 3D model importer and a light system (point lights, spot lights and directional lights) and basic physics (gravity and box-sphere collision calculation and reaction)." 
      depthDescription2='' videoLink="" imagePath={GraphicsProj}></ProjectBox>
      ...
      depthDescription="The project was made with Visual Studio Code, being composed of html, css and tsx files. It has been split in several pages and components in order to have 
